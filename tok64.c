...
#define VERSION "1.4"
#define VDATE "6/15/96"
#define VCOMM "Basic extensions. More special keywords."
#define COPYRIGHT "1996"
#define AUTHOR "Cris Berneburg"
#define EMAIL "<crisb@bigfoot.com>"
#define WEB "http://www.geocities.com/stegos/"
...
void exit_illeg_subs (int line_num, int col)
{
...
void txt2prg (FILE *in, FILE *out, int casemode, int colmode)
{
   ...
   while (readline (line, MAXLINE, in) != EOF)
   {
      if (colmode)
                        {
